...
<%@page import="py.una.pol.par.util.Utils" %>
...
<nav>
    <ul id="appleNav">
        ...
        <li>
            <form id="form-logout" action="<%= request.getContextPath()%>/UsuariosServlet" method="post">
        ...
        <li style="width: 80px;">
            <a href="#" title="Versión <%=Utils.getVERSION()%>">Versión <%=Utils.getVERSION()%></a>
        </li>
    </ul>
</nav>
